...
const goalsDictionary: Languages = {
  ...
  text: {
    ru: [
      ...
      "Давайте продолжать жечь, чтобы достичь ваших целей, это больно только временно, не сдавайтесь",
      "Давайте начнем здоровый образ жизни вместе, мы поможем подобрать вам рацион на каждый день. Здоровое питание - это весело",
